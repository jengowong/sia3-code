...
<div>
    ...
    <form:form method="POST" action="${spitterform_url}" modelAttribute="spitter">

        Full name: <form:input path="fullName" size="15"/><br/>
        Username: <form:input path="username" size="15" maxlength="15"/><br/>
        Password: <form:password path="password" size="30" showPassword="true"/><br/>
