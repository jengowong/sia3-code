...
@Repository
public class HibernateSpitterDaoSession implements SpitterDao {

    private SessionFactory sessionFactory;

    @Autowired
    public HibernateSpitterDaoSession(SessionFactory sessionFactory) {//<co id="co_injectSessionFactory"/>
